                    ...
                    <?php if (!empty($student_result)): ?>
                        <ul class="list-group">
                            <?php foreach ($student_result as $student): ?>
                                <li class="list-group-item"><strong>Mã sinh viên:</strong> <?php echo htmlspecialchars($student['student_id']); ?></li>
                                <li class="list-group-item"><strong>Tên sinh viên:</strong> <?php echo htmlspecialchars($student['name']); ?></li>
                                <li class="list-group-item"><strong>Email:</strong> <?php echo htmlspecialchars($student['email']); ?></li>
                                <li class="list-group-item"><strong>Điện thoại:</strong> <?php echo htmlspecialchars($student['phone']); ?></li>
                            <?php endforeach; ?>
                        </ul>
                    <?php else: ?>
